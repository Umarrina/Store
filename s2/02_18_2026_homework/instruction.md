...
```
docker cp "s2\02_18_2026_homework\migrations\V1__initial_schema.sql" db_practice:/tmp/V1.sql
...
$template = Get-Content "s2\02_16_2026_homework\migrations\V2__create_role.sql" -Raw
...
```
docker cp "s2\02_16_2026_homework\migrations\V3__alter_all_tables.sql" db_practice:/tmp/V3.sql
...
```
docker cp "s2\02_16_2026_homework\migrations\seed_data.sql" db_practice:/tmp/V4.sql
